...
const FilterDropdown = (props: FilterDropdownProps) => {
    ...
    if (name === '가격') {
        ...
        dropdown = <ReviewDropdown clickModal={clickModal} resetFilter={resetFilter} categoryInput={categoryInput} />;
    } else if (name === '스토어') {
        dropdown = <StoreDropdown clickModal={clickModal} resetFilter={resetFilter} categoryInput={categoryInput} storeList={storeList} />;
    } else if (name === '정렬') {
        dropdown = <SortByDropdown clickModal={clickModal} categoryChange={categoryChange} />;
    }
