...
interface PriceDropdownProps {
    clickModal: () => void;
    resetFilter: () => void;
    categoryInput: (event: React.ChangeEvent<HTMLInputElement>) => void;
}

const PriceDropdown = (props: PriceDropdownProps) => {
    const { clickModal, resetFilter, categoryInput } = props;
                                ...
                                <div className="range-slider-container">
                                    <div className="range-slider-wrapper">
                                        <input
                                            ...
                                            value={steamRate}
                                            onChange={(event) => {
                                                setSteamRate(event.target.value);
                                                categoryInput(event);
                                            }}
                                        />
                                    </div>
                            ...
                            <div className="range-container d-flex flex-justify-end">
                                ...
                                >
                                    <input
                                        type="text"
                                        autoComplete="off"
                                        className="input-slider-range range-item range-input"
                                        name="steamRating"
